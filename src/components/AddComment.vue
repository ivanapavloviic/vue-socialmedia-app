<template>
  <form @submit.prevent="addComment" class="flex items-end">
    ...
    <button v-if="content.length>0" type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline">Submit</button>
